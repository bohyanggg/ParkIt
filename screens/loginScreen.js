...
const LoginScreen = ({ navigation }) => {
  ...
  const isVerified = () => {
    return auth.currentUser !== null && auth.currentUser.emailVerified !== false
      ? true
      : false;
  };
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.buttons}>
          <View style={styles.navigators}>
            <Button title="Login" color="#5D0EEA" onPress={handleLogin} />
          </View>
        </View>
        ...
        <View style={styles.navigators}>
          ...
          >
            <Text style={styles.forgotPasswordStyle}>Or Sign Up</Text>
          </Pressable>
        </View>
      </SafeAreaView>
    </TouchableWithoutFeedback>
